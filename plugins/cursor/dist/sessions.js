...
async function listSessions(cwd = process.cwd()) {
  try {
    ...
    for (const row of parsed) {
      ...
      const rec = row;
      const id = typeof rec["id"] === "string" && rec["id"] || typeof rec["chat_id"] === "string" && rec["chat_id"] || typeof rec["chatId"] === "string" && rec["chatId"];
      if (!id) continue;
      const summary = typeof rec["summary"] === "string" ? rec["summary"] : typeof rec["title"] === "string" ? rec["title"] : void 0;
      const updatedAt = typeof rec["updated_at"] === "string" ? rec["updated_at"] : typeof rec["updatedAt"] === "string" ? rec["updatedAt"] : void 0;
      const entry = { id };
...
function repoHash(repoRoot2) {
  const canonical = existsSync(repoRoot2) ? realpathSync(repoRoot2) : resolve(repoRoot2);
...
function listJobs(repoPath, opts = {}) {
  ...
  for (const f of files) {
    try {
      const raw = readFileSync3(join2(dir, f), "utf8");
